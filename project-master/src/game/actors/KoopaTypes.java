...
/**
 * Class representing the Koopa Types that implements Resettable
 *
 * @author Ting Yi Xuan, Goh Kai Yuan, Jonathan Koh
 * @version 1.0.0
 * @see Actor
 */
public abstract class KoopaTypes extends Actor implements Resettable {
    /**
    ...
    /**
     * the list of monologues that is going to output by all Koopa Types
     */
     ...
     * Constructor.
     */
    public KoopaTypes(String name, char displayChar, int hitpoints) {
    ...
    /**
     * get the Weapon of Koopa with creating a new instance of Intrinsic Weapon
     */
